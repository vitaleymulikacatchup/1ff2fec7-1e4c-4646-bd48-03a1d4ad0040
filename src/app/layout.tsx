...
export const metadata: Metadata = {
  title: "MyBrand - Local E-Com Store",
  description: "Explore exclusive products and deals from MyBrand, your go-to local e-commerce store.",
  keywords: "ecommerce, local store, MyBrand, products, deals",
  openGraph: {
    title: "MyBrand - Local E-Com Store",
    description: "Explore exclusive products and deals from MyBrand, your go-to local e-commerce store.",
    siteName: "MyBrand",
